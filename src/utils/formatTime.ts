 ...
 * @returns 返回三个月内的日期数组
 */
export function getThreeMonthsLater(format: string): string[] {
	let currentDate = new Date();  
	let threeMonthsLater = new Date();  
	threeMonthsLater.setMonth(currentDate.getMonth() + 3);
	return [formatDate(currentDate, format),formatDate(threeMonthsLater, format)];
}
 ...
 * @returns 返回半年内的日期数组
 */
export function getSixMonthsLater(format: string): string[] {
	let currentDate = new Date();  
	let sixMonthsLater = new Date();
	sixMonthsLater.setMonth(currentDate.getMonth() + 6);
	return [formatDate(currentDate, format),formatDate(sixMonthsLater, format)];
}
 ...
 * @returns 返回一年内的日期数组
 */
export function getOneYearLater(format: string): string[] {
	let currentDate = new Date();  
