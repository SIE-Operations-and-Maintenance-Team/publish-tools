        ...
        <div class="layout-drawer-content-flex">
          ...
          <div class="layout-drawer-content-item" @click="onSetLayout('transverse')">
            ...
            <div
              class="layout-tips-warp"
              :class="{
                'layout-tips-warp-active': getThemeConfig.layout === 'transverse',
              }"
            >
              <div class="layout-tips-box">
...
const onBgColorPickerChange = (bg: string) => {
  let themeBg = themeConfig.value as any;
  document.documentElement.style.setProperty(`--next-bg-${bg}`, themeBg[bg]);
  if (bg === "menuBar") {
    document.documentElement.style.setProperty(
      `--next-bg-menuBar-light-1`,
      getLightColor(getThemeConfig.value.menuBar, 0.05)
    );
  }
...
onMounted(() => {
  nextTick(() => {
    ...
    mittBus.on<any>("layoutMobileResize", (res: LayoutMobileResize) => {
